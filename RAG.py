...
def standard_prompt(context, query):
    return f"""You are an expert AI assistant. Use the following context to answer the question clearly and concisely.
...
def generate_with_groq(prompt):
    ...
    body = {
        "model": GROQ_MODEL,
        "messages": [
            {"role": "system", "content": "Youre a knowledgable assistant."},
...
def run_rag(query, k=3, model_name="all-MiniLM-L6-v2", store_path="faiss_store", use_alternative_prompt=False, rewrite=False):
